...
function _mean(data::Array{Float64,1})::Float64
    ...
    #something about writing a funciton from Julia website
    #added mean(data)
...
#things that were typed
#add... all the things
#include("Submit.jl")
#U = F.U
#dot(U[:,1],U[:,1])
#include("plotme-VaRExplained.jl") - this gave me the graph
#d = important(F.U[:,1], list_of_measurements)
#include("plotme-PC12.jl")
